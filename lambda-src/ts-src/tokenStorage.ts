...
const gcalTokenTableName = "atlasBot_SlackIdToGCalToken";
const atlasTokenTableName = "atlasBot_SlackIdToAtlassianToken";
...
export async function getAtlassianToken(slackUserId: string) {
  return await getToken(atlasTokenTableName, slackUserId);
}

export async function saveAtlassianToken(token:string, slackUserId:string) {
  return await saveToken(atlasTokenTableName, token, slackUserId);
}
...
export async function deleteAtlassianToken(slackUserId:string) {
  return await deleteToken(atlasTokenTableName, slackUserId);
}
